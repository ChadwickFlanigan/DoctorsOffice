...
namespace CS6232_G2.DAL
{
    ...
    public class PatientVisitDAL
    {
        ...
        {
            string saveStatement = string.Empty;

            if (visit.PatientVisitID == 0)
            {
                saveStatement = "INSERT INTO PatientVisits " +
            ...
            {
                saveStatement = @"UPDATE [dbo].[PatientVisits]
                            SET [visitDateAndTime] = @visitDateAndTime
            ...
            using (SqlConnection connection = G2ProjectConnectionString.GetConnection())
            {
                ...
                SqlCommand insertCommand = new SqlCommand(saveStatement, connection);
                {
                    ...
                    if (visit.PatientVisitID > 0)
                    {
                        insertCommand.Parameters.AddWithValue("@patientVisitId", visit.PatientVisitID);
                    }
